...
search = Button(text="Search Website", bg="Blue",fg="white", command=find_password, width=16)
search.grid(row=1, column=2)
# generate button creation
generate_button = Button(text="Generate Password", command=generate_new_password, width=16)
